describe 'Routes', type: :routing do
  ...
  describe "Features" do
    ...
    it "routes to the features controller" do
      expect(get: '/admin/features').to route_to(controller: 'curation_concerns/admin/features', action: 'index')
    end

    it "routes to the strategies controller" do
      expect(patch: '/admin/features/foo/strategies/bar').to route_to(controller: 'curation_concerns/admin/strategies', action: 'update', id: 'bar', feature_id: 'foo')
    end
  end
  ...
  describe 'Admin' do
    ...
    it 'routes the statistics page' do
      expect(get: '/admin/stats').to route_to(controller: 'curation_concerns/admin/stats', action: 'show')
    end
  end
